...
export async function handler(event, context) {
  ...
  try {
    ...
    const collection = database.collection("wishlist"); // Replace 'mycollection' with your collection name

    const wishlist = await collection.findOne({ user: newData.user });
